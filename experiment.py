...
def main():
    ...
    print("Condition (0: block, 1: interchange): ", params["condition"])
    print("Rule to start with (0: four-in-a-row, 1: knobby): ", params["model"])
...
def end_experiment():
    ...
    print("Experiment is complete. Thank you for participating!")
...
def call_human_play():
    print("Current game rule (0: 4iar, 1: knobby): ", params["model"])
...
def move_files_with_id(participant_id):
    ...
    files_with_id = get_files_with_prefix(participant_id)
...
def get_files_with_prefix(participant_id):
