...
def calculate_win_rate(params_path):
    ...
    # Calculate win rates
    win_rate_four = win_count_four / game_count_four
    win_rate_knobby = win_count_knobby / game_count_knobby
...
for file_name, file_paths in duplicates.items():
    ...
    for path in file_paths:
        win_four, win_knobby, _ = calculate_win_rate(path)
